...
<div className="mb-8">
    ...
    <label className="flex items-center gap-3 w-full cursor-pointer">
        <input
            ...
            onChange={() => updateURL({ category_ids: [], page: 1 })}
            className="accent-cream w-5 h-5 rounded"
        />
        <span className={`font-mont ${selectedCategories.length === 0 ? "text-cream font-bold" : "text-gray"}`}>
    ...
    {categories.map((cat) => (
        <label key={cat.id} className="flex items-center gap-3 w-full cursor-pointer mt-2">
            <input
                type="checkbox"
                ...
                className="accent-cream w-5 h-5 rounded"
            />
            <span className={`font-mont ${selectedCategories.includes(cat.id) ? "text-cream font-medium" : "text-gray"}`}>
