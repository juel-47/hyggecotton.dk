...
const ContactPage = ({ branches, footer_info }) => {
    const [formData, setFormData] = useState({
        firstName: "",
        lastName: "",
        email: "",
    ...
    const handleSubmit = (e) => {
        ...
        router.post("/contact", payload, {
            ...
            onError: (errors) => {
                setSubmitStatus("error");
                const msg = Object.values(errors).join(". ") || "Something went wrong. Please try again.";
                setErrorMsg(msg);
            },
            onFinish: () => {
            ...
            <div className="px-5 2xl:px-20 container mx-auto">
                ...
                <div className="text-center mb-16">
                    ...
                    <p className="text-sm text-gray max-w-sm mx-auto font-mont">
                        ...
                        Orci molestie a eu arcu. Sed ut tincidunt integerum id sem.
                ...
                <div className="grid grid-cols-1 xl:grid-cols-4 gap-[30px] mb-8">
                    {branches.map((branch) => (
                        <div
                            className="w-full bg-dark2 rounded-xl overflow-hidden"
                            key={branch.id}
                        >
                            <div className="p-4">
                                <h4 className="text-cream font-bold text-[24px] font-mont">
                            ...
                            <div className="space-y-6">
                                {footer_info?.address && (
                                    <div className="flex items-start">
                                        ...
                                        <div>
                                            <h3 className="font-medium text-cream font-mont">Address</h3>
                                            <p className="text-gray font-mont">{footer_info.address}</p>
                                        </div>
                                    </div>
                                )}
                                ...
                                {footer_info?.phone && (
                                    <div className="flex items-start">
                                        ...
                                        <div>
                                            <h3 className="font-medium text-cream font-mont">Phone</h3>
                                            <p className="text-gray font-mont">{footer_info.phone}</p>
                                        </div>
                                    </div>
                                )}
                                ...
                                {footer_info?.email && (
                                    <div className="flex items-start">
                                        ...
                                        <div>
                                            <h3 className="font-medium text-cream font-mont">Email</h3>
                                            <p className="text-gray font-mont">{footer_info.email}</p>
                                        </div>
                                    </div>
                                )}
                            </div>
                            ...
                            <form onSubmit={handleSubmit} className="space-y-6">
                                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                                    <div>
                                        ...
                                        <input
                                            ...
                                            value={formData.firstName}
                                            onChange={handleInputChange}
                                            className="w-full px-4 py-3 bg-dark1 border border-gray-700 rounded-lg text-cream outline-none focus:border-cream transition"
                                            required
                                        />
                                    </div>
                                    <div>
                                ...
                                <div>
                                    ...
                                    <textarea
                                        ...
                                        value={formData.message}
                                        onChange={handleInputChange}
                                        className="w-full px-4 py-3 bg-dark1 border border-gray-700 rounded-lg text-cream outline-none focus:border-cream transition resize-none"
                                        required
                                    />
                                </div>
                                ...
                                <div>
                                    <button
                                        type="submit"
                                        disabled={submitStatus === "loading"}
                                        className={`w-full py-3 px-6 rounded-lg font-medium transition-colors font-mont ${
                                            submitStatus === "loading"
                                    ...
                                    {submitStatus === "error" && (
                                        <p className="mt-3 text-red-400 text-center font-mont">
                                            {errorMsg}
                                        </p>
                                    )}
                                </div>
