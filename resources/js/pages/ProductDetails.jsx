...
const ProductDetails = () => {
    ...
    const handleCustomizeClick = () => {
        ...
        router.get(
            route("product-customize", product.id),
            {
                        ...
                        <div className="w-full">
                            ...
                            <div className="flex flex-col sm:flex-row gap-4 md:gap-[47px]">
                                <button
                                    ...
                                    className={`flex items-center gap-2.5 font-medium text-[16px] font-mont xl:text-sm text-cream text-center rounded-[10px] py-4 xl:py-2 px-8 cursor-pointer transition-all bg-red hover:bg-red-700`}
                                >
                                    Add to cart
                                    {!isOutOfStock &&
                                        quantity <= maxAvailableQty && (
                            ...
                            <div className="grid grid-cols-1 lg:grid-cols-2 gap-10 pt-20">
                                ...
                                <div>
                                    {reviews.length > 0 ? (
                                        ...
                                        <p className="text-gray text-[20px] font-mont">
                                            No reviews yet
                                        </p>
                                    )}
                                </div>
                                    ...
                                    <form onSubmit={handleReviewSubmit}>
                                        <div className="mb-8">
                                            <Rating
                                                ...
                                                emptySymbol={
                                                    <MdOutlineStarBorder className="text-red text-[28px]" />
                                                }
                                                fullSymbol={
                                                    <MdOutlineStar className="text-red text-[28px]" />
                                                }
