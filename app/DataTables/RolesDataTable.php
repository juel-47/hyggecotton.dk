...
class RolesDataTable extends DataTable
{
    ...
    public function dataTable(QueryBuilder $query): EloquentDataTable
    {
        return (new EloquentDataTable($query))
            ->addColumn('action', function ($query) {
                // if ($query->id == 1 && $query->name === 'SuperAdmin') {
                ...
                $deleteBtn = "<a href='" . route('admin.role.destroy', $query->id) . "'class='btn btn-danger ml-2 delete-item'><i class='fas fa-trash'></i></i></a>";
    ...
    {
        return $model->newQuery()->where('guard_name', 'web')->orderBy('id', 'asc');
    }
